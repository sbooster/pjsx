...
import { ComponentType, VNode, Component, FunctionComponent, PreactDOMAttributes, ClassAttributes } from 'preact';
import { Publisher } from '@pjsx/core';

// TODO подумать как не копировать из preact, а сделать по человечески
...
declare function jsx(tag: any, props: any, key?: string): preact.VNode<any>;
declare const Fragment: preact.FunctionComponent<{}>;

export { Fragment, JSXInternal as JSX, jsx, jsx as jsxDEV, jsx as jsxs };
